...
import '../../component/reactant/farm.css';
...
export default function Product() {
    return (
        ...
        <div className="container-fluid bg-light row p-5">
            <div className="col-lg-5 borp">
                {/* <img src={farmm} className="col-lg-12"/> */}
            </div>
            <div className="col-lg-7 bg-light mt-5 p-5">
                <div className="row mr-5">
                    <h5 className="text-success mr-5">HAPPY FARMING</h5>
                    <h1 className="text-warning font-italic">HAPPY ANIMALS</h1>
